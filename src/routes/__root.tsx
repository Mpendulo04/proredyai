...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered workplace tools: generate emails, plan tasks, and summarize research — no signup, no data stored." },
      { property: "og:title", content: "AI Workplace Productivity Assistant" },
      { property: "og:description", content: "AI-powered workplace tools: generate emails, plan tasks, and summarize research — no signup, no data stored." },
